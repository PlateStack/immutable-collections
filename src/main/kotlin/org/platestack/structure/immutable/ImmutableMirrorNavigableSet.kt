...
internal class ImmutableMirrorNavigableSet<E>(private val backend: NavigableSet<E>):
        AbstractImmutableNavigableSet<E>(),
        NavigableSet<E> by Collections.unmodifiableNavigableSet(backend),
